...
class userdefinationsController extends Controller
{
        public function addClient()
        {
        	...
        	return view('users.addClient',compact('page_title','Commercial_names','mo7afazat'));
        }
        ...
        public function addMandoub()
        {
        	...
        	return view('users.addMandoub',compact('page_title','Commercial_names','mo7afazat'));
        }
        ...
        public function adduser()
        {
        	...
        	return view('users.adduser',compact('page_title','Commercial_names','mo7afazat'));
        }
