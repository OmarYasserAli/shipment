                            ...
                            <div id='shipment_form'>
                                <div class="post__content tab-content">
                                    <div id="content" class="tab-pane p-5 active" role="tabpanel" aria-labelledby=	"content-tab">
                                        <div class="form-inline">
                                            <label for="mandob" class="form-label sm:w-20">مندوب التسليم</label>
                                            <input id="mandob" type="text" class="form-control" disabled>
                                        </div>
           ...
           $('#print').on('click', function(){
                ...
                $.ajax({
                            ...
                            success: function(result){
                                window.open("{{route('shipment.taslim_qr_save')}}"+'?pdf=1&report='+result.id+'');
            ...
            $( "#qr_new" ).click(function() {
                ...
                $( "#tanfez" ).click(function() {
                    ...
                    $.ajax({
                        url: "{{route('shipment.taslim_qr_save')}}" ,
                        type: 'post',
                ...
                $( "#QR" ).keyup(function(e){
                    if(e.keyCode == 13)
                    {
                        ...
                        if(qr=='') return;
                        $.ajax("{{route('getShipmentsByCode')}}"+"?code="+qr+"&status="+current_status+"&case=taslim_qr",   // request url
                            {
