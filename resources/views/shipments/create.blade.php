                ...
                <div class="top-bar">
                    ...
                    <div class="intro-x relative mr-3 sm:mr-6">
                        <div class="search hidden sm:block">
                            <input type="text" class="search__input form-control border-transparent" ="Search...">
                                ...
                                <div id="content" class="tab-pane p-5 active" role="tabpanel" aria-labelledby=	"content-tab">
                                    <div class="form-inline">
                                        ...
                                        <div class="grid grid-cols-12 gap-2"> 
                                            <input type="date" class="form-control col-span-4"  aria-label="default input inline 1"> 
                                        </div> 
                                    </div>
                                    ...
                                    <div class="form-inline mt-3">
                                        ...
                                        <input id="3amil-name" type="text" class="form-control"  />
                                    </div>
                                    <div class="form-inline mt-3">
                                        <label for="commercial-name" class="form-label sm:w-20">الاسم التجارى</label>
                                        <input id="commercial-name" type="text" class="form-control"  />
                                    </div>
                                    <div class="form-inline mt-3">
                                    ...
                                    <div class="form-inline mt-3">
                                        ...
                                        <div class="grid grid-cols-12  mr-10"> 
                                            ...
                                            <input type="text" class="form-control col-span-2"  aria-label="default input inline 1"> 
                                            <label for="horizontal-form-1" class="form-label col-span-2" style="text-align:left; margin-left:15px; margin-top:8px; ">مبلغ التوصيل</label>
                                            <input type="text" class="form-control col-span-2"  aria-label="default input inline 1"> 
