                    ...
                    <div class="col-span-2">
                        <div class="grid grid-cols-3 ">
                            ...
                            <div class="form-inline 3amil">
                                <label for="horizontal-form-1" class="form-label" style=" text-align:left; margin-left:15px; margin-top:1px; width:30px; ">منوب التسليم</label>
                                ...
                                <input type="hidden" value="@if(request()->get('client_id')!= null){{request()->get('client_id')}}@else الكل @endif" name='client_id'>
                                    <div class="mr-6 alert alert-outline-secondary alert-dismissible show flex items-center mb-2" role="alert">
                                       ...
                                       @if(request()->get('client_id') == null)الكل@endif
                                        <button type="button" class="btn-close" data-tw-dismiss="alert" aria-label="Close" onclick="window.location.replace('{{route('accounting.mandoubtaslim.mosadad')}}')">
                ...
                <table class="table table-striped" id="dataTable">
                    ...
                    <tbody>
                        ...
                        <tr  class="status_{!!$shipment->Status_!!}_color"   >
                            ...
                            <td class="whitespace-nowrap " >{{$shipment->tarikh_tasdid_mandoub_eltaslim}}</td>
                            ...
                            <td class="whitespace-nowrap " >{{$shipment->code_}}</td>
                                    <td class="whitespace-nowrap " ><input type="checkbox" class="check_count" data-cost='{{$shipment->shipment_coast_}}'
                                        data-t7wel='{{$shipment->tas3ir_mandoub_taslim}}' data-net='{{$shipment->shipment_coast_}}' data-code='{{$shipment->code_}}' data-status='{{$shipment->Status_}}' data-arba7='{{$shipment->arba7}}'></td>
                        </tr>
                        @endforeach
        ...
        <script type="text/javascript">
            ...
            $( "#modal_close" ).click(function() {
                ...
                if(noClientFilter ){
                    myModal.hide();
                        ...
                        window.location.href = "{{route('accounting.mandoubtaslim.mosadad')}}?client_id="+client_id;
                    }
            });
            ...
            $( "#qr_new" ).click(function() {
                ...
                $( "#tasdid" ).click(function() {
                 ...
                 $.ajax({
                     url: "{{route('accounting.mandoubtaslim.canceltasdid')}}" ,
                     type: 'post',
            ...
            function infinteLoadMore(page) {
                $.ajax({
                    url: "{{route('accounting.mandoubtaslim.mosadad')}}"+ "?lodaMore=1&page=" + page+'&'+window.location.search.substr(1),
                ...
                .done(function (response) {
                    ...
                    $.each(response.data,function(key,value){
                        ...
                        $('#dataTable   tr:last').after(`<tr  class='status_`+value.Status_+`_color'>
                            ...
                            <td  class="whitespace-nowrap " >`+value.tarikh_tasdid_mandoub_eltaslim+`</td>
                            <td  class="whitespace-nowrap " >`+value.branch_+`</td>
                            <td  class="whitespace-nowrap " >`+(value.shipment_coast_ - value.tas3ir_mandoub_taslim).toLocaleString('en-US')+`</td>
                            <td  class="whitespace-nowrap " >`+value.tas3ir_mandoub_taslim.toLocaleString('en-US')+`</td>
