                    ...
                    <div class="col-span-2">
                        <div class="grid grid-cols-3 ">
                            ...
                            <div class="form-inline 3amil">
                                <label for="horizontal-form-1" class="form-label" style=" text-align:left; margin-left:15px; margin-top:1px; width:30px; ">مندوب التسليم</label>
                                ...
                                <input type="hidden" value="@if(request()->get('client_id')!= null){{request()->get('client_id')}}@else الكل @endif" name='client_id'>
                                    <div class="mr-6 alert alert-outline-secondary alert-dismissible show flex items-center mb-2" role="alert">
                                       ...
                                       @if(request()->get('client_id') == null)الكل@endif
                                        <button type="button" class="btn-close" data-tw-dismiss="alert" aria-label="Close" onclick="window.location.replace('{{route('accounting.mandoubtaslim.notmosadad')}}')">
            ...
            $( "#qr_new" ).click(function() {
                ...
                $( "#tasdid" ).click(function() {
                 ...
                 $.ajax({
                     ...
                     type: 'post',
                     data:{ code:codes, client:client ,amount:amount  , _token: "{{ csrf_token() }}"},
                     error: function(e){
                         console.log(e);
                     },
                     success: function(res) {
