    ...
    <div id="type_modal" class="modal" data-tw-backdrop="static" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body px-5 py-10">
                    <div class="text-center">
                        <div class="mb-5" style="font-size: 25px">اسم مندوب الاستلام</div>
                ...
                <table class="table table-striped" id="dataTable">
                    ...
                    <tbody>
                        ...
                        <tr  class="status_{!!$shipment->Status_!!}_color"   >
                            ...
                            <td class="whitespace-nowrap " >{{$shipment->shipment_coast_ - $shipment->tas3ir_mandoub_estlam}}</td>
                            <td class="whitespace-nowrap " >{{$shipment->tas3ir_mandoub_estlam}}</td>
    ...
    <div style="background-color:#fff;  opacity: 1;position: fixed; bottom:0px; z-index:999; width:79%;" class="flex h-12 pt-3 rounded ">
        ...
        <script type="text/javascript">
            ...
            $( "#modal_close" ).click(function() {
                ...
                if(noClientFilter ){
                    myModal.hide();
                        ...
                        window.location.href = "{{route('accounting.mandoubestlam.notmosadad')}}?client_id="+client_id;
                    }
            });
            ...
            $( "#qr_new" ).click(function() {
                ...
                console.log(codes)
                 $.ajax({
                     url: "{{route('accounting.mandoubestlam.tasdid')}}" ,
                     type: 'post',
            ...
            function infinteLoadMore(page) {
                $.ajax({
                    url: "{{route('accounting.mandoubestlam.notmosadad')}}"+ "?lodaMore=1&page=" + page+'&'+window.location.search.substr(1),
                ...
                .done(function (response) {
                    ...
                    $.each(response.data,function(key,value){
                        ...
                        $('#dataTable   tr:last').after(`<tr  class='status_`+value.Status_+`_color'>
                            ...
                            <td  class="whitespace-nowrap " >`+(value.shipment_coast_ -value.tas3ir_mandoub_estlam) +`</td>
