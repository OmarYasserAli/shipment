...
<!-- END: Modal Content -->
    ...
    <div class="intro-y  grid-cols-12 gap-5 mt-5">
        ...
        <div class="intro-y col-span-12 lg:col-span-12">
            <a href="{{route("ads.create")}}" class="btn btn-success  align-left mr-1"  style="direction: ltr">اضافة اعلان جديد</a>
                ...
                <table class="table table-striped" id="dataTable">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th class="whitespace-nowrap">الرابط</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td  class="whitespace-nowrap " >{{$ad->name }}</td>
                            <td  class="whitespace-nowrap " ><a href="{{$ad->link }}" target="_blank">رابط الصورة</a></td>
